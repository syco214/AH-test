...
const toWallet = new web3.PublicKey("BHSG8XeaKU74g5d7MEFSj4HjM5yoPKrQ6Lzhc9uLcSv1");
  // Construct my token class
const myMint = new web3.PublicKey("BNTYkJdHkdP9eH4uGouRkqz9RifYL8knHVVVmBMgcNzx");
      ...
      <SwapBox>
        ...
        {!loading && !!wallet?.connected && noTokensFound && (
          <div style={{ textAlign: "center" }}>
            <Title2>NGMI</Title2>
            <About>No Bounty Hunter in Wallet</About>
            <Button
              variant="outlined"
              target="_blank"
